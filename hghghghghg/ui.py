...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.field_text.setGeometry(QtCore.QRect(50, 0, 301, 531))
        self.field_text.setStyleSheet("background-color: rgb(57, 255, 113);")
        self.field_text.setObjectName("field_text")
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(370, 0, 256, 192))
        self.listWidget.setStyleSheet("background-color: rgb(227, 222, 255);")
        self.listWidget.setObjectName("listWidget")
        self.listWidget_2 = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_2.setGeometry(QtCore.QRect(370, 290, 256, 161))
        self.listWidget_2.setStyleSheet("background-color: rgb(158, 88, 255);")
        self.listWidget_2.setObjectName("listWidget_2")
        self.button_note_create = QtWidgets.QPushButton(self.centralwidget)
        self.button_note_create.setGeometry(QtCore.QRect(370, 200, 121, 23))
        self.button_note_create.setStyleSheet("color: rgb(0, 255, 255);")
        self.button_note_create.setObjectName("button_note_create")
        self.button_note_del = QtWidgets.QPushButton(self.centralwidget)
        self.button_note_del.setGeometry(QtCore.QRect(500, 200, 121, 23))
        self.button_note_del.setStyleSheet("background-color: rgb(70, 82, 255);")
        self.button_note_del.setObjectName("button_note_del")
        self.button_note_save = QtWidgets.QPushButton(self.centralwidget)
        self.button_note_save.setGeometry(QtCore.QRect(370, 230, 256, 23))
        self.button_note_save.setStyleSheet("background-color: rgb(255, 255, 0);")
        self.button_note_save.setObjectName("button_note_save")
        self.button_tag_add = QtWidgets.QPushButton(self.centralwidget)
        self.button_tag_add.setGeometry(QtCore.QRect(370, 480, 121, 23))
        self.button_tag_add.setStyleSheet("background-color: rgb(255, 217, 184);")
        self.button_tag_add.setObjectName("button_tag_add")
        self.button_tag_del = QtWidgets.QPushButton(self.centralwidget)
        self.button_tag_del.setGeometry(QtCore.QRect(500, 480, 121, 23))
        self.button_tag_del.setStyleSheet("background-color: rgb(255, 28, 88);")
        self.button_tag_del.setObjectName("button_tag_del")
        self.button_tag_search = QtWidgets.QPushButton(self.centralwidget)
        self.button_tag_search.setGeometry(QtCore.QRect(370, 510, 256, 23))
        self.button_tag_search.setStyleSheet("background-color: rgb(85, 85, 0);")
        self.button_tag_search.setObjectName("button_tag_search")
        self.list_notes_label = QtWidgets.QLabel(self.centralwidget)
        self.list_notes_label.setGeometry(QtCore.QRect(370, 0, 256, 20))
        self.list_notes_label.setObjectName("list_notes_label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(370, 290, 256, 20))
        self.label_2.setObjectName("label_2")
        self.field_tag = QtWidgets.QLineEdit(self.centralwidget)
        self.field_tag.setGeometry(QtCore.QRect(370, 450, 256, 23))
        self.field_tag.setStyleSheet("background-color: rgb(41, 144, 255);")
